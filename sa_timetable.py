...
if __name__ == "__main__":
    ...
    # Running with three cooling rates: 0.80, 0.95, 0.995
    # ==========================================================================

    print("\n" + "=" * 48)
    print("  EXPERIMENT 2 - Cooling Rate = 0.80")
    print("=" * 48)
    ...
    print("\n" + "=" * 48)
    print("  EXPERIMENT 2 - Cooling Rate = 0.95")
    print("=" * 48)
    ...
    print("\n" + "=" * 48)
    print("  EXPERIMENT 2 - Cooling Rate = 0.995")
    print("=" * 48)
